...
async def seed(session: AsyncSession) -> None:
    ...
    if existing_org is None:
        org = Organisation(
            ...
            is_active=True,
            extra_metadata={"seeded": True, "seeded_at": now.isoformat()},
            created_at=now,
            updated_at=now,
        )
        session.add(org)
    ...
    sensors_to_seed = [
        Sensor(
            ...
            status="active",
            is_active=True,
            extra_metadata={"location_note": "inlet_zone", "installation_date": "2022-03-15"},
            created_at=now,
            updated_at=now,
        ),
        Sensor(
            ...
            status="active",
            is_active=True,
            extra_metadata={"location_note": "central", "installation_date": "2022-03-15"},
            created_at=now,
            updated_at=now,
        ),
        Sensor(
        ...
        Sensor(
            ...
            status="active",
            is_active=True,
            extra_metadata={"location_note": "outlet_zone", "installation_date": "2022-03-15"},
            created_at=now,
            updated_at=now,
        ),
        Sensor(
            ...
            status="active",
            is_active=True,
            extra_metadata={"location_note": "deep_zone", "installation_date": "2023-01-10"},
            created_at=now,
            updated_at=now,
        ),
        Sensor(
            ...
            status="active",
            is_active=True,
            extra_metadata={"location_note": "inlet_zone", "installation_date": "2023-01-10"},
            created_at=now,
            updated_at=now,
        ),
    ]
